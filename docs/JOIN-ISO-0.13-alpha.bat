...
echo Cartella: %CD%
echo.
if not exist "Quelo-Audiomaker-0.13-alpha.iso.part00" goto missing
if not exist "Quelo-Audiomaker-0.13-alpha.iso.part01" goto missing
...
echo OK: creato Quelo-Audiomaker-0.13-alpha.iso
goto end
:missing
