Quelo Audiomaker 0.12-alpha — ISO spezzata (GitHub)
===================================================
...
1) Scarica nella stessa cartella:
   ...
   - JOIN-ISO-0.12-alpha.bat (Windows) oppure JOIN-ISO-0.12-alpha.sh (Linux)

2) Unisci:
   Windows: doppio clic su JOIN-ISO-0.12-alpha.bat
   Linux:   bash JOIN-ISO-0.12-alpha.sh
...
3) Preferisci un solo file già pronto?
   https://click2all.org/iso/Quelo-Audiomaker-0.12-alpha.iso

Release: https://github.com/alby-quelo/Quelo-Audiomaker/releases/tag/0.12-alpha


Quelo Audiomaker 0.12-alpha — split ISO (GitHub)
================================================

GitHub rejects files over 2 GB. The ISO (~2.5 GB) is split into 2 parts.

1) Download into the same folder:
   - Quelo-Audiomaker-0.12-alpha.iso.part00 … part01
   - Quelo-Audiomaker-0.12-alpha.iso.sha256 (optional)
   - JOIN-ISO-0.12-alpha.bat (Windows) or JOIN-ISO-0.12-alpha.sh (Linux)
