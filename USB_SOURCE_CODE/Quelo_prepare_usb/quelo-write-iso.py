    ...
    *,
    ...
    try:
        if IS_WINDOWS:
            ...
            # O_DIRECT vero (allineato a settore via mmap sotto): evita che
            # "Finalizzazione" scarichi tutta la ISO dalla page cache in blocco.
    ...
    elif used_direct and not IS_WINDOWS:
        print("Scrittura con O_DIRECT (I/O diretto sul dispositivo).")
